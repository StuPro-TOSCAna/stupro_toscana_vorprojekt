...
public  class ArchiveHandlerTest {
    ...
    public void zipWithoutModel() throws ArchiveHandler.ArchiveException {
        ...
        archiveHandler.parseModelXml();
    }
    @Test
    public void zipWithModel() throws ArchiveHandler.ArchiveException {
        ArchiveHandler archiveHandler = new ArchiveHandler(new File(testResFolder+"zipwithmodel.zip"));
        String result = archiveHandler.parseModelXml();
